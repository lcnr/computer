...
| `0x3cxx3d` | ljmpgtecc | if Accu >= mem[PC + 1] { P1 = 0; P2 = mem[PC + 3] } else { PC += 4}|
| `0x3dxx3c` | ljmpltcc  | if Accu < mem[PC + 1] { P1 = 0; P2 = mem[PC + 3] } else { PC += 4} |
...
| `0x42xx43` | ljmpgtecm | if Accu >= mem[PC + 1] { P1 = 0; P2 = mem[MR] } else { PC += 3}    |
| `0x43xx42` | ljmpltcm  | if Accu < mem[PC + 1] { P1 = 0; P2 = mem[MR] } else { PC += 3}     |
...
| `0x4849`   | ljmpgtemc | if Accu >= mem[MR] { P1 = 0; P2 = mem[PC + 2] } else { PC += 3}    |
| `0x4948`   | ljmpltmc  | if Accu < mem[MR] { P1 = 0; P2 = mem[PC + 2] } else { PC += 3}     |
